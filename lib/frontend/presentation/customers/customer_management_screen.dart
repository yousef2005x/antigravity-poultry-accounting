...
import 'package:poultry_accounting/frontend/presentation/customers/customer_form_screen.dart';
        ...
        if (_entries.isNotEmpty && _selectedCustomer != null)
          Padding(
            ...
            child: ElevatedButton.icon(
              ...
              label: const Text('طھطµط¯ظٹط± PDF'),
              ...
              children: [
                ...
                Row(
                  children: [
                    if (entry.debit > 0)
                      Text(
                        'ط¯ظٹظ†: ${entry.debit.toStringAsFixed(2)}',
                        style: const TextStyle(color: Colors.red, fontSize: 13),
                      ),
                    if (entry.debit > 0 && entry.credit > 0) const SizedBox(width: 8),
                    if (entry.credit > 0)
                      Text(
                        'ط¯ظپط¹: ${entry.credit.toStringAsFixed(2)}',
